        ...
        <nav className="absolute bg-transparent w-full border-gray-200 dark:bg-gray-900">
            <div className="flex flex-wrap items-center justify-around mx-auto h-20">
                <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <span className="text-white self-center text-3xl font-semibold whitespace-nowrap dark:text-white">DIMATA</span>
                </Link>
                <button
                ...
                <div className="hidden justify-end w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-medium text-xl flex flex-col p-4 md:p-0 mt-4 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                        <li>
                            <Link
                                href="/"
                                className={`block py-2 px-3 ${router.pathname === '/'
                                        ? 'text-amber-500'
                        ...
                        <li>
                            <Link
                                href="/about"
                                className={`block py-2 px-3 ${router.pathname === '/about'
                                        ? 'text-amber-500'
                                        : 'text-white hover:text-amber-600'
                                    } md:p-0`}
                            >
                        ...
                        <li>
                            <Link
                                href="/services"
                                className={`block py-2 px-3 ${router.pathname === '/services'
                                        ? 'text-amber-500'
                                        : 'text-white hover:text-amber-600'
                                    } md:p-0`}
                            >
                        ...
                        <li>
                            <Link
                                href="/products"
                                className={`block py-2 px-3 ${router.pathname === '/products'
                                        ? 'text-amber-500'
                                        : 'text-white hover:text-amber-600'
                                    } md:p-0`}
                            >
                        ...
                        <li>
                            <Link
                                href="/projects"
                                className={`block py-2 px-3 ${router.pathname === '/projects'
                                        ? 'text-amber-500'
                                        : 'text-white hover:text-amber-600'
                                    } md:p-0`}
                            >
                        ...
                        <li>
                            <Link
                                href="/contact"
                                className={`block py-2 px-3 ${router.pathname === '/contact'
                                        ? 'text-amber-500'
                                        : 'text-white hover:text-amber-600'
                                    } md:p-0`}
                            >
